        ...
        <div className="mt-3">
            ...
            {files?.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-3">
                    {files.map((f, i) => (
                        <div key={i} className="relative group border-2 border-gray-200 rounded-lg overflow-hidden bg-gray-50 flex flex-col items-center justify-center w-24 h-24">
                            {f.data?.startsWith('data:image') ? (
                                ...
                                <div className="flex flex-col items-center gap-1 p-2">
                                    ...
                                    <span className="text-[9px] text-gray-500 text-center truncate w-full px-1">{f.name}</span>
                                </div>
                            )}
...
const DoctorForm = ({ onAddToList, hospitalName }) => {
    ...
    const handleAddToList = () => {
        if (!doctorData.name.trim()) { setError('Doctor name is required.'); return; }
        if (!doctorData.email.trim()) { setError('Doctor email is required.'); return; }
    ...
    return (
        <div className="border-2 border-blue-200 rounded-xl p-6 bg-blue-50/40">
            ...
            {doctorStep === 1 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value={doctorData.email} onChange={handleChange} placeholder="doctor@example.com" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Phone</label>
                        <input type="text" name="phone" value={doctorData.phone} onChange={handleChange} placeholder="+91 9876543210" className={inputCls} />
                    </div>
                    <div className="md:col-span-2">
                        <ImageUploadField label="Photo" value={doctorData.photo}
                            onChange={(val) => setDoctorData(prev => ({ ...prev, photo: val }))}
                            placeholder="https://..." />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Is Active?</label>
                        <div className="flex items-center gap-2 mt-1">
                            <input type="checkbox" name="is_active" checked={doctorData.is_active} onChange={handleChange} className="w-4 h-4 text-blue-600 rounded" />
                            <span className="text-sm text-gray-600">Active</span>
                        </div>
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Is Verified?</label>
                        <div className="flex items-center gap-2 mt-1">
                            <input type="checkbox" name="is_verified" checked={doctorData.is_verified} onChange={handleChange} className="w-4 h-4 text-blue-600 rounded" />
            ...
            {doctorStep === 2 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Degrees <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.degrees} onChange={e => handleArrayInputChange(e, 'degrees')} onBlur={() => handleArrayInputBlur('degrees')} placeholder="MBBS, MD, DM" className={inputCls} />
                        {doctorData.degrees.length > 0 && <p className="mt-1 text-xs text-blue-600">Saved: {doctorData.degrees.join(', ')}</p>}
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Specialities <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.specialities} onChange={e => handleArrayInputChange(e, 'specialities')} onBlur={() => handleArrayInputBlur('specialities')} placeholder="Cardiology, Internal Medicine" className={inputCls} />
                        {doctorData.specialities.length > 0 && <p className="mt-1 text-xs text-blue-600">Saved: {doctorData.specialities.join(', ')}</p>}
                    </div>
                    <div className="md:col-span-2">
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Sitting Plan <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.sitting_plan} onChange={e => handleArrayInputChange(e, 'sitting_plan')} onBlur={() => handleArrayInputBlur('sitting_plan')} placeholder="Monday: 8AM-9PM, Tuesday: 7AM-6PM" className={inputCls} />
                    ...
                    <div>
                        ...
                        <input type="number" name="experience_in_years" value={doctorData.experience_in_years} onChange={handleChange} placeholder="5" min="0" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Registration Number</label>
                        <input type="text" name="registration_number" value={doctorData.registration_number} onChange={handleChange} placeholder="MCI-12345" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Consultation Fee (₹)</label>
                        <input type="number" name="consultation_fee" value={doctorData.consultation_fee} onChange={handleChange} placeholder="500" min="0" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Languages Spoken <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.languages_spoken} onChange={e => handleArrayInputChange(e, 'languages_spoken')} onBlur={() => handleArrayInputBlur('languages_spoken')} placeholder="English, Hindi" className={inputCls} />
                    </div>
                </div>
            )}
            ...
            {doctorStep === 3 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="city" value={doctorData.city} onChange={handleChange} placeholder="Delhi" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">State</label>
                        <input type="text" name="state" value={doctorData.state} onChange={handleChange} placeholder="Delhi" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Country</label>
                        <input type="text" name="country" value={doctorData.country} onChange={handleChange} placeholder="India" className={inputCls} />
                    </div>
                    <div className="md:col-span-2">
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Address</label>
                        <textarea name="address" value={doctorData.address} onChange={handleChange} rows={3} placeholder="Full Address" className={inputCls} />
                    </div>
                </div>
            )}
            ...
            {doctorStep === 4 && (
                <div className="space-y-4">
                    <div>
                        ...
                        <textarea name="overview" value={doctorData.overview} onChange={handleChange} rows={3} placeholder="Doctor's bio and description..." className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Awards & Recognitions <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.awards_and_recognitions} onChange={e => handleArrayInputChange(e, 'awards_and_recognitions')} onBlur={() => handleArrayInputBlur('awards_and_recognitions')} placeholder="Best Doctor 2023, Excellence Award" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Publications <span className="text-xs text-gray-400">(comma-separated)</span></label>
                        <input type="text" value={localArrayInputs.publications} onChange={e => handleArrayInputChange(e, 'publications')} onBlur={() => handleArrayInputBlur('publications')} placeholder="Journal of Medicine 2023" className={inputCls} />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Total Reviews</label>
                            <input type="number" name="total_reviews" value={doctorData.total_reviews} onChange={handleChange} placeholder="0" min="0" className={inputCls} />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Average Rating</label>
                            <input type="number" name="average_rating" value={doctorData.average_rating} onChange={handleChange} placeholder="0" min="0" max="5" step="0.1" className={inputCls} />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Patients Treated</label>
                            <input type="number" name="total_patients_treated" value={doctorData.total_patients_treated} onChange={handleChange} placeholder="0" min="0" className={inputCls} />
                        </div>
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Meta Title</label>
                        <input type="text" name="meta_title" value={doctorData.meta_title} onChange={handleChange} placeholder="SEO title" className={inputCls} />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Meta Description</label>
                        <textarea name="meta_description" value={doctorData.meta_description} onChange={handleChange} rows={2} placeholder="SEO description" className={inputCls} />
                    </div>
                </div>
            )}
            ...
            <div className="mt-6 flex justify-between items-center">
                <div className="flex gap-2">
                    <button type="button" onClick={() => setDoctorStep(s => Math.max(1, s - 1))} disabled={doctorStep === 1}
                    ...
                    <button type="button" onClick={() => setDoctorStep(s => Math.min(4, s + 1))} disabled={doctorStep === 4}
                        className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-300 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1">
        ...
        <div className="border-2 border-gray-200 rounded-xl bg-white overflow-hidden">
            <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-blue-100 rounded-full flex items-center justify-center text-blue-700 font-bold text-sm shrink-0">{index + 1}</div>
                    <div>
                        <p className="font-semibold text-gray-900 text-sm">{doctor.name}</p>
                        <p className="text-xs text-gray-500">{doctor.email}{doctor.specialities?.length > 0 && ` · ${doctor.specialities.join(', ')}`}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <button type="button" onClick={() => setExpanded(e => !e)} className="p-1.5 text-gray-400 hover:text-blue-600 transition-colors">
                        {expanded ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
                    </button>
                    <button type="button" onClick={() => onRemove(index)} className="p-1.5 text-gray-400 hover:text-red-600 transition-colors">
            ...
            {expanded && (
                <div className="px-4 pb-4 pt-2 border-t border-gray-100 grid grid-cols-2 md:grid-cols-3 gap-3 text-xs text-gray-600 bg-gray-50">
                    ...
                    {doctor.sitting_plan?.length > 0 && <span className="col-span-2 md:col-span-3"><strong>Sitting Plan:</strong> {doctor.sitting_plan.join(', ')}</span>}
                    {doctor.languages_spoken?.length > 0 && <span><strong>Languages:</strong> {doctor.languages_spoken.join(', ')}</span>}
                    <span>
                        <strong>Status:</strong>{' '}
                        <span className={doctor.is_active ? 'text-green-600' : 'text-red-500'}>{doctor.is_active ? 'Active' : 'Inactive'}</span>
                        {' · '}
                        <span className={doctor.is_verified ? 'text-blue-600' : 'text-gray-400'}>{doctor.is_verified ? 'Verified' : 'Unverified'}</span>
                    </span>
                </div>
            )}
        </div>
...
const AdminHospitalForm = () => {
    const [formData, setFormData] = useState({
        ...
        certifications: [], available_specialities: [], available_treatments: [],
    ...
    useEffect(() => {
        try { localStorage.setItem(STORAGE_KEY, JSON.stringify(doctorList)); } catch { }
    }, [doctorList]);
    ...
    const handleGalleryFileUpload = (e) => {
        Array.from(e.target.files).forEach(file => {
            const reader = new FileReader();
            reader.onloadend = () => {
                setFormData(prev => ({ ...prev, gallery_images: [...prev.gallery_images, reader.result] }));
            };
            reader.readAsDataURL(file);
        });
        e.target.value = '';
    ...
    const handleAddCertificateFile = (data, name) => {
        setFormData(prev => ({ ...prev, certificate_files: [...prev.certificate_files, { data, name }] }));
    };

    const handleRemoveCertificateFile = (index) => {
        setFormData(prev => ({ ...prev, certificate_files: prev.certificate_files.filter((_, i) => i !== index) }));
    };
        ...
        <Fragment>
            <div className="min-h-screen bg-blue-50 py-8 px-4 sm:px-6 lg:px-8 ">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 overflow-x-auto">
                        <div className="flex gap-2 min-w-max px-4">
                            {steps.map((step) => {
                                ...
                                return (
                                    <button key={step.id} onClick={() => { if (step.id <= currentStep) setCurrentStep(step.id); }} type="button"
                                        ...
                                        <span className={`text-sm font-medium ${currentStep === step.id ? 'text-gray-900' : 'text-gray-600'}`}>
                                            ...
                                            {step.id === 8 && doctorList.length > 0 && (
                                                <span className="ml-1.5 bg-green-500 text-white text-xs rounded-full px-1.5 py-0.5">{doctorList.length}</span>
                                            )}
                                        </span>
                                    </button>
                                );
                    ...
                    {message.text && (
                        <div className={`mb-6 p-4 rounded-lg flex items-start gap-3 ${message.type === 'success' ? 'bg-green-50 border-2 border-green-500 text-green-800' : message.type === 'warning' ? 'bg-yellow-50 border-2 border-yellow-500 text-yellow-800' : 'bg-red-50 border-2 border-red-500 text-red-800'}`}>
                            ...
                            <div>
                                ...
                                {submitDetails?.doctorsFailed?.length > 0 && (
                                    <ul className="mt-2 space-y-1 text-sm">
                                        {submitDetails.doctorsFailed.map((d, i) => <li key={i}>• <strong>{d.name}</strong>: {d.reason}</li>)}
                                    </ul>
                                )}
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} onKeyDown={(e) => { if (e.key === 'Enter') e.preventDefault(); }}
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={formData.uuid} readOnly className="w-full px-4 py-3 bg-gray-100 border-2 border-gray-300 rounded-lg text-gray-600 cursor-not-allowed font-mono text-sm" />
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Hospital Name <span className="text-red-500">*</span></label>
                                        <input type="text" name="name" value={formData.name} onChange={handleNameChange} required maxLength={200} placeholder="Enter hospital name" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                    </div>
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Slug (Auto-generated from name)</label>
                                        <input type="text" name="slug" value={formData.slug} onChange={handleChange} maxLength={200} placeholder="hospital-name-slug" className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        <p className="mt-1 text-xs text-gray-500">URL-friendly version of the hospital name</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Phone Number <span className="text-red-500">*</span></label>
                                        <input type="tel" name="phone" value={formData.phone} onChange={handleChange} required maxLength={20} placeholder="+91 1234567890" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Email <span className="text-red-500">*</span></label>
                                        <input type="email" name="email" value={formData.email} onChange={handleChange} required maxLength={255} placeholder="hospital@example.com" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                    </div>
                                    <div className="md:col-span-2">
                                        <ImageUploadField label="Hospital Photo" value={formData.photo}
                        ...
                        {currentStep === 3 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="about" value={formData.about} onChange={handleChange} rows={6} placeholder="Detailed description about the hospital, facilities, services, etc." className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                </div>
                            </div>
                        )}
                        ...
                        {currentStep === 4 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="timing_display" value={formData.timing_display} onChange={handleChange} maxLength={100} placeholder="e.g., 24/7, Mon-Sat: 8AM-8PM" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all" />
                                </div>
                            </div>
                        )}
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input type="text" value={localArrayInputs.certifications} onChange={e => handleArrayInputChange(e, 'certifications')} onBlur={() => handleArrayInputBlur('certifications')} placeholder="NABH, JCI, ISO 9001:2015" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        <CertificateUploadField files={formData.certificate_files} onAdd={handleAddCertificateFile} onRemove={handleRemoveCertificateFile} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Specialities Available (comma-separated)</label>
                                        <input type="text" value={localArrayInputs.available_specialities} onChange={e => handleArrayInputChange(e, 'available_specialities')} onBlur={() => handleArrayInputBlur('available_specialities')} placeholder="Cardiology, Neurology, Orthopedics" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Treatments Available <span className="text-xs text-gray-400">(comma-separated)</span></label>
                                        <input type="text" value={localArrayInputs.available_treatments} onChange={e => handleArrayInputChange(e, 'available_treatments')} onBlur={() => handleArrayInputBlur('available_treatments')} placeholder="Cataract, Total Knee Replacement, Endocrinology" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        {formData.available_treatments.length > 0 && <p className="mt-1 text-xs text-blue-600">Saved: {formData.available_treatments.join(', ')}</p>}
                                    </div>
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 bg-blue-50 p-4 rounded-lg border-2 border-blue-200">
                                            {AVAILABLE_SERVICES.map(service => (
                                                <label key={service} className="flex items-center gap-2 cursor-pointer group">
                                                    <input type="checkbox" checked={formData.available_services.includes(service)} onChange={() => handleServiceCheckbox(service)} className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" />
                                                    <span className="text-sm text-gray-700 group-hover:text-blue-700 transition-colors">{service}</span>
                                                </label>
                                            ))}
                                        </div>
                                        {formData.available_services.length > 0 && <p className="mt-2 text-xs text-blue-600 font-medium">Selected ({formData.available_services.length}): {formData.available_services.join(', ')}</p>}
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="number" name="total_doctors" value={formData.total_doctors} onChange={handleChange} min="0" placeholder="0" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Total Specialities</label>
                                        <input type="number" name="total_specialities" value={formData.total_specialities} onChange={handleChange} min="0" placeholder="0" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all" />
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {currentStep === 7 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="file" accept="image/*" multiple onChange={handleGalleryFileUpload} className="w-full px-4 py-3 border-2 border-dashed border-blue-300 rounded-lg bg-blue-50 text-sm text-gray-600 cursor-pointer file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-500 file:text-white hover:file:bg-blue-600 transition-all" />
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        <input type="text" value={galleryUrlInput} onChange={e => setGalleryUrlInput(e.target.value)} onBlur={handleGalleryUrlBlur} placeholder="https://example.com/img1.jpg, https://..." className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        <button type="button" onClick={handleGalleryUrlBlur} className="px-4 py-3 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors whitespace-nowrap">Add URLs</button>
                                    </div>
                                </div>
                                {formData.gallery_images.length > 0 && (
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-3">Preview ({formData.gallery_images.length} image{formData.gallery_images.length > 1 ? 's' : ''})</label>
                                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                            {formData.gallery_images.map((img, index) => (
                                                <div key={index} className="relative group rounded-lg overflow-hidden border-2 border-gray-200 aspect-square">
                                                    ...
                                                    <button type="button" onClick={() => handleRemoveGalleryImage(index)} className="absolute top-1 right-1 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-600">✕</button>
                        ...
                        {currentStep === 8 && (
                            <div className="space-y-6">
                                <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-green-200">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-0.5">Fill details → <strong>Add to List</strong> → repeat for each doctor.</p>
                                        </div>
                                    </div>
                                ...
                                {showDoctorForm && <DoctorForm onAddToList={handleAddDoctorToList} hospitalName={formData.name} />}
                                {doctorList.length > 0 ? (
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-sm font-semibold text-gray-700 flex items-center gap-2"><Users className="w-4 h-4 text-green-600" />Doctors Added ({doctorList.length})</h3>
                                            {!showDoctorForm && <button type="button" onClick={() => setShowDoctorForm(true)} className="text-xs text-green-600 hover:text-green-700 font-semibold flex items-center gap-1"><UserPlus className="w-3.5 h-3.5" /> Add Another</button>}
                                        </div>
                                        {doctorList.map((doctor, index) => <DoctorListCard key={doctor.uuid} doctor={doctor} index={index} onRemove={handleRemoveDoctor} />)}
                                    </div>
                                ) : (
                                    !showDoctorForm && (
                                        <div className="text-center py-12 border-2 border-dashed border-gray-200 rounded-xl">
                                            ...
                                            <p className="text-gray-400 text-xs mt-1">This step is optional — you can skip and submit without doctors.</p>
                                        </div>
                                    )
                                )}
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input type="text" name="meta_title" value={formData.meta_title} onChange={handleChange} maxLength={200} placeholder="SEO-friendly title for search engines" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        <p className="mt-1 text-xs text-gray-500">Recommended length: 50-60 characters</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">Meta Description</label>
                                        <textarea name="meta_description" value={formData.meta_description} onChange={handleChange} rows={3} placeholder="Brief description for search engine results" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
                                        <p className="mt-1 text-xs text-gray-500">Recommended length: 150-160 characters</p>
                                    </div>
                                    <div className="bg-blue-50 p-6 rounded-lg border-2 border-blue-200">
                                        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2"><Shield className="w-5 h-5 text-blue-600" />Status & Verification</h3>
                                        <div className="flex gap-8">
                                            <label className="flex items-center cursor-pointer">
                                                <input type="checkbox" name="is_active" checked={formData.is_active} onChange={handleChange} className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" />
                                                <span className="ml-3 text-sm font-semibold text-gray-700">Is Active</span>
                                            </label>
                                            <label className="flex items-center cursor-pointer">
                                                <input type="checkbox" name="is_verified" checked={formData.is_verified} onChange={handleChange} className="w-5 h-5 text-orange-600 border-gray-300 rounded focus:ring-2 focus:ring-orange-500" />
                                    ...
                                    {doctorList.length > 0 && (
                                        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 flex items-center gap-3">
                                            ...
                                            <p className="text-sm text-green-800 font-medium">{doctorList.length} doctor{doctorList.length > 1 ? 's' : ''} ready — will be saved to the doctors table on submit.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between items-end pt-6 border-t-2 border-gray-200 mt-8">
                            ...
                            {currentStep < steps.length ? (
                                <div className="flex flex-col items-end gap-1">
                                    <span className="text-xs text-gray-400 font-medium tracking-wide uppercase">Next: {steps[currentStep].title}</span>
                                    <button type="button" onClick={handleNext} className="px-6 py-3 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors flex items-center gap-2">
                                        Next <ChevronRight className="w-5 h-5" />
                                    </button>
                                </div>
                            ) : (
                                <button type="submit" disabled={loading} className="px-6 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                                    <Save className="w-5 h-5" />
                                    {loading ? 'Saving...' : `Submit Hospital${doctorList.length > 0 ? ` + ${doctorList.length} Doctor${doctorList.length > 1 ? 's' : ''}` : ''}`}
                                </button>
                            )}
                        </div>
                    </form>
